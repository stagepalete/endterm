...
public class Main {
    // TODO:
    // Library: Users.User(States.State):Class, Books.Book:Class, States.State(Interface), States.AdminState(Class of States.State), States.UserState(Class of States.State), Library,
    // Program Interface, Database.DatabaseConnector


    // Arman: Books.Book:Class, Library:Class
